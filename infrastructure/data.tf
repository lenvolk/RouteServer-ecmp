...
#   name                = "adminusername"
#   key_vault_id        = "/subscriptions/${data.azurerm_subscription.current.subscription_id}/resourceGroups/RS/providers/Microsoft.KeyVault/vaults/cs-keystore"
# }
...
data "template_file" "csrconfig" {
  ...
  vars = {
    ...
    SHAREDKEY = "ciscocisco" #data.azurerm_key_vault_secret.sharedkey.value
  }
}
